                	...
                	<div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        ...
                        <div class="me-3">
                            <select name="countries" class="custome_select">
                                ...
                                <option value='GBR' data-title="GBR">INR</option>
                            </select>
                        </div>
                        <ul class="contact_detail text-center text-lg-start">
                            <li><i class="ti-mobile"></i><span>+91-8115814123</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
    	...
    	<div class="container">
            <nav class="navbar navbar-expand-lg"> 
                <a class="navbar-brand" href="index.php">
                    <img class="logo_light" src="assets/images/bookshoplogo.png" alt="logo" />
                    <img class="logo_dark" src="assets/images/bookshoplogo1.png" alt="logo" />
                </a>
